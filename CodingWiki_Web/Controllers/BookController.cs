...
public class BookController : Controller
{
    ...
    public IActionResult ManageAuthors(int id)
    {
        ...
        {
            BookAuthorList = _db.BookAuthorMap.Include(u => u.Author).Include(u => u.Book)
    ...
    public IActionResult RemoveAuthors(int authorId, BookAuthorVM bookAuthorVM)
    {
        ...
        BookAuthorMap bookAuthorMap = _db.BookAuthorMap.FirstOrDefault(
    ...
    public async Task<IActionResult> Playground()
    {
        ...
        var viewList2 = _db.MainBookDetails.Where(m => m.Price > 30);

        // Raw SQL
        var bookRaw = _db.Books.FromSqlRaw("Select * from Books").ToList();
        var id = 1;
        var bookRaw1 = _db.Books.FromSqlInterpolated($"Select * from Books where bookid={id}").ToList();

        // SP
        var bookSP = _db.Books.FromSqlInterpolated($"exec getAllBookDetails {id}").ToList();
